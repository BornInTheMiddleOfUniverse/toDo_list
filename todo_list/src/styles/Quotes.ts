...
export const ArcContainer = tw.div`absolute mb-20 w-auto ml-[110px]`;
export const ArcSvg = tw.svg`relative mt-16 overflow-visible `;
export const ArcText = tw.text` text-3xl tracking-widest `;

export const QuotesBody = tw.div`bg-transparent flex flex-col items-center mt-14 font-waterfall text-4xl text-white p-9`;
export const Quote = tw.div``;
export const Author = tw.div`mt-4`;
